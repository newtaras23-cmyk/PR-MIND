export const insights = [
  {
    ...
    sections: [
      {
        heading: { en: "The moment of verification", uk: "Момент перевірки" },
        paragraphs: {
          en: [
      ...
      {
        heading: { en: "Where the friction shows up", uk: "Де виникає тертя" },
        paragraphs: {
          en: [
    ...
    faq: [
      {
        question: { en: "Does online reputation really affect sales?", uk: "Чи справді онлайн-репутація впливає на продажі?" },
        answer: {
  ...
  },
  {
    ...
    sections: [
      {
        heading: { en: "Position is only half the signal", uk: "Позиція — лише половина сигналу" },
        paragraphs: {
          en: [
      ...
      {
        heading: { en: "Building a controlled top 10", uk: "Побудова контрольованого топ-10" },
        paragraphs: {
          en: [
    ...
    faq: [
      {
        question: { en: "How fast can search results change?", uk: "Наскільки швидко можуть змінюватися результати пошуку?" },
        answer: {
  ...
  },
  {
    ...
    sections: [
      {
        heading: { en: "Hour one: confirm before you respond", uk: "Перша година: підтвердьте, перш ніж реагувати" },
        paragraphs: {
          en: [
      ...
      {
        heading: { en: "Day one and two: one channel, one message", uk: "Перший і другий день: один канал, одне повідомлення" },
        paragraphs: {
          en: [
    ...
    faq: [
      {
        question: { en: "Should we respond publicly right away?", uk: "Чи варто одразу реагувати публічно?" },
        answer: {
      ...
      {
        question: { en: "Who should be involved in the first 48 hours?", uk: "Хто має бути залучений у перші 48 годин?" },
        answer: {
