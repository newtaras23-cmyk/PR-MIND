  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <button
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[color:var(--action)] text-[color:var(--on-gold)] shadow-2xl transition hover:brightness-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--action)]"
      >
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex border-t border-[color:var(--line)] bg-[color:var(--ink)]/95 backdrop-blur md:hidden">
      ...
      <a
        ...
        className="flex flex-1 items-center justify-center gap-2 border-l border-[color:var(--line)] bg-[color:var(--action-dim)] py-4 text-sm font-medium text-[color:var(--on-gold)]"
      >
